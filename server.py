...
if __name__ == "__main__":
    # 1. Cloud platforms dynamically assign ports via environment variables
    port = int(os.environ.get("PORT", 8000))
    
    # 2. You must bind to '0.0.0.0' in the cloud to accept external traffic
    ...
    # 3. Removed webbrowser.open(url) because cloud servers do not have monitors/browsers
